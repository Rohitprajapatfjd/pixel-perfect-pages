  ...
  return (
    <section className="bg-[hsl(var(--page-bg))] py-16 px-6">
      <div className="max-w-[1200px] mx-auto">
        <div className="bg-gradient-to-r from-[#0b0f3b] to-[#1e3a8a] rounded-2xl px-8 py-12 md:py-16 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <button className="flex items-center gap-3 bg-gray-900 text-white px-6 py-3 rounded-xl hover:bg-gray-800 transition-colors">
              ...
              <div className="text-left">
                ...
                <p className="text-sm font-semibold">Google Store</p>
              </div>
              <ChevronRight className="w-5 h-5 text-white/60" />
            </button>

            {/* App Store */}
            <button className="flex items-center gap-3 bg-white text-gray-900 px-6 py-3 rounded-xl hover:bg-gray-50 transition-colors">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">

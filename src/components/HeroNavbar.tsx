   ...
   return (
     <nav className="relative z-10 flex items-center justify-between h-16">
       ...
       <div className="flex items-center gap-2">
         ...
         <span className="text-xl font-bold text-white">Stockbazaari</span>
       </div>
       ...
       <a
         href="#"
         className="flex items-center gap-2 text-white font-medium text-sm hover:opacity-90 transition-opacity group"
       >
         Download Now
